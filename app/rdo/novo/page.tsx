...
export default function NovoRDOPage() {
  useEffect(() => {
    window.location.href = 'https://rdo.metriclab.com.br/rdo/novo';
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[#F0F0F0] flex flex-col items-center justify-center p-6 text-center">
      ...
      <p className="text-[14px] text-[#111111] font-medium">Abrindo RDO...</p>
      <a
        href="https://rdo.metriclab.com.br/rdo/novo"
